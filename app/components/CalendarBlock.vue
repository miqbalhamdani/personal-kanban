  ...
  <ContextMenu>
    <ContextMenuTrigger as-child>
      <div
        ...
        role="button"
        tabindex="0"
        class="group absolute inset-x-1 z-10 flex cursor-grab flex-col overflow-hidden border-l-2 bg-card px-2 py-1 text-left shadow-[0_1px_2px_rgba(80,66,56,0.07)] transition-shadow duration-150 hover:shadow-[0_4px_10px_rgba(80,66,56,0.14)] active:cursor-grabbing"
        :style="style"
